...
public class ValkyrieServer implements AppListener, Serializable, DisconnectHandle {
  private static final Logger logger = Logger.getLogger(ValkyrieServer.class.getName());
...
//      logger.log(Level.INFO, "macio mode : {0} ", macio.getMode().getType());
